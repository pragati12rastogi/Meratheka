            ...
            if(($handle = fopen($tmpName, 'r')) !== FALSE) {
                ...
                while(($data = fgetcsv($handle, 1000, ',')) !== FALSE) {
                    // number of fields in the csv
                      ...
                      $data[0] = mysqli_real_escape_string($con,trim($data[0]));
                      ...
                      if($error == ''){
                        ...
                        else 
                        {
                          ...
                          // $con->query("INSERT INTO `subcategory`(`cat_id`, `name`, `img`, `created_by`) VALUES (".$chec_cat['id'].",'".$data[0]."','".mysqli_real_escape_string($con,$img)."',1)");
                            $con->query('INSERT INTO `subcategory`(`cat_id`, `name`, `img`, `created_by`) VALUES ('.$chec_cat['id'].',"'.$data[0].'","'.mysqli_real_escape_string($con,$data[2]).'",1)');
        ...
        <script type="text/javascript">
          ...
          $(document).ready(function() {
            if(error == ''){
              ...
              toastr.info('Import sub category Successfully!!');
              setTimeout(function()
              {
